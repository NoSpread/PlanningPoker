...
INSERT INTO `accounts` (`id`, `username`, `email`, `password`, `last_ip`, `register_ip`, `last_login`, `created_at`) VALUES
	(1, 'admin', 'admin@mail.de', '$argon2id$v=19$m=65536,t=4,p=1$TlpkVnouZmxiU0l1MnViUA$ZE2wgGwDe+tu+7W285pKpMj05hC2nY/EYAfaRGbymho', _binary '', _binary 0x30, '2020-05-24 12:52:49', '2020-05-10 21:32:31'),
...
-- Dumping data for table planningpoker.invites: ~38 rows (approximately)
...
-- Dumping data for table planningpoker.played_cards: ~17 rows (approximately)
